...
public class TC_Bus_009 extends BaseClass{
	@Test(priority = 1)
	...
	public void viewSeats() {
		Reporter.log("Landed in BusResultPage Successfully");
		BusResultPage busResultPage=new BusResultPage(driver);
		busResultPage.getPreviousDayLink().click();
		Reporter.log("Clicked on PreviousDayLink Successfully");
	}
